...
# ============================================================
# MECHANISM SCREENER (v2.2, 2026-09 — 延伸研究 #01/#02)
# ============================================================
# GOR≥45 不再「触发即配油」：先过三屏筛选器（拆腿 / 恐慌签名 / 油迫近）。
# 裁决：绿=恐慌✓且≥2/3（历史预期命中率≈83%）｜黄=观察区｜红=体制重定价候选。
# 油气腿上限系数（相对区间基础表；数字可调，先按研究结论）：
SCREENER_OIL_CAP = {"绿": 1.0, "黄": 0.5, "红": 0.0}
SCREENER_VIX_PCTL = 0.80   # 恐慌签名：VIX ≥ 滚动10年 P80
SCREENER_OIL_PCTL = 0.25   # 油迫近：WTI ≤ 滚动10年 P25
